...
JoyConMacR = "60:6B:FF:D3:75:E4"
JoyConMacL = "60:6B:FF:D3:8E:F6"
		...
		while True:
			try:
				for event in gamepadL.read_loop():   #this loops infinitely
					...
					handle_button(JL_BUTTON_MINUS,e.KEY_ENTER)
					handle_button(JL_BUTTON_L1, e.KEY_O)
					handle_button(JL_BUTTON_L2, e.KEY_P)
					handle_button(JL_BUTTON_TUMB, e.KEY_M)

					handle_stick(JL_STICK_UP, JL_STICK_DOWN, e.KEY_G, e.KEY_T)
					handle_stick(JL_STICK_LEFT, JL_STICK_RIGHT, e.KEY_F, e.KEY_H)
		...
		while True:
			try:
				for event in gamepadR.read_loop():  # this loops infinitely
					...
					time.sleep(0.02)
					# Right controller
					handle_button(JR_BUTTON_A, e.KEY_A)
					...
					handle_button(JR_BUTTON_R2, e.KEY_Z)
					handle_button(JR_BUTTON_TUMB, e.KEY_N)

					handle_stick(JR_STICK_UP, JR_STICK_DOWN, e.KEY_0, e.KEY_1)
					handle_stick(JR_STICK_LEFT, JR_STICK_RIGHT, e.KEY_2, e.KEY_3)
